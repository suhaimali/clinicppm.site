...
const MainApp = () => {
    ...
    const renderContent = () => {
        switch(currentScreen) {
            ...
            case 'history': return <PlaceholderPage title="Patients History" icon={Clock} color={['#8b5cf6', '#7c3aed']} theme={theme} layout={layout} onBack={() => setCurrentScreen('home')} styles={styles} />;
